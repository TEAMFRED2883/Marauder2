...
public class PixyCamSPI {
	...
	private static final Logger logger =
			Logger.getLogger(PixyCamSPI.class.getName());
	...
	public PixyCamSPI(SPI argPixy, HashMap<Integer, ArrayList<PixyPacket>> argPixyPacket, PixyException argPixyException){
		pixy = argPixy;
